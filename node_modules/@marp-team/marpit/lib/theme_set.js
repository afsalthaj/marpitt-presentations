...
class ThemeSet {
  ...
  getThemeProp(theme, prop) {
    ...
    if (prop.startsWith('meta.')) {
      console.warn('Deprecation warning: Dot notation path in getThemeProp to get meta value has no longer supported. We still have a special fallback into getThemeMeta method, but it would remove soon.');
